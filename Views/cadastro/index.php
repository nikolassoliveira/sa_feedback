  ...
  <div class="container-footer">
    ...
    <section id="faleconosco" onclick="faleconosco()">
     ...
     <section id="socialmediaicon">
      ...
      <button class="btn btn-light" type="button"> <a href="https://instagram.com/magiadoslivro?igshid=YmMyMTA2M2Y=">  <i class="fa-brands fa-instagram"></i> Instagram </a> </button>
